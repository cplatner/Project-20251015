...
public class PeopleQueryByNameUnitTests
{
    [Fact]
    ...
    [Fact]
    public async Task GetByName_3ItemsInDb_NameNotFound_ThrowsException()
    {
        // Arrange
        var mockRepo = new Mock<IPeopleRepository>();
        var people = new List<PersonAstronaut>
        ...
        // Act
        var result = () => handler.Handle(new GetPersonByName() { Name = "Todd Davis"}, CancellationToken.None);
